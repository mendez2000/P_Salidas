...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        echo '<script>
            alert("El Registro de Memoria fue actualizado correctamente");
            window.location = "/R_Memorias/php/Imp_Memoria.php?id='.$id.'";
          </script>';
    } else {
        echo '<script>
        alert("El Registro de Memorias NO pudo ser actualizado");
