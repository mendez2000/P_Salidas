			...
			<table id="tabla">
				<thead>
					<tr>
						...
						<th width="auto">Nombre del Rol</th>
						<th>Editar</th>
						<th>Eliminar</th>
					</tr>
				</thead>
				<tbody>
					...
					<?php
					$sql = "SELECT * FROM roles ORDER BY roles.id DESC";
					...
					?>
						<tr>
							...
							<td><a class="btn btn-success" href="/R_MEMORIAS/php/Editar_Roles.php?id=<?php echo $row->id; ?>">Editar</a>
							<td><a class="btn btn-danger" href="/R_MEMORIAS/php/Borrar_Roles.php?id=<?php echo $row->id; ?>" onclick="return confirm('Estás seguro que deseas eliminar el registro?');">Eliminar</a>
						</tr>
					<?php
					}
					?>
