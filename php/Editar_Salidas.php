...
if (isset($_POST['submit'])) {
    ...
    if (!$result) {
        echo '<script>
        alert("El Pase de Salida se actualizo correctamente");
                window.location = "/R_Memorias/php/Imp_Salidas.php?id='.$id.'";
              </script>';
    } else {
        echo '<script>
        alert("El Pase de Salida NO se pudo actualizar");
        ...
        <form action="" method="post" class="form-grid">
            ...
            <thead>
                ...
                <div style="grid-column: span 3; text-align: center;">
                    <td><input class="btn-submit" type="submit" name="submit" value="Actualizar"></td>
