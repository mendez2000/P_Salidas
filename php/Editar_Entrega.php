...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        echo '<script>
        alert("El registro de Entrega fue actualizado correctamente");
            window.location = "/R_Memorias/php/Imp_Entrega.php?id='.$id.'";
          </script>';
    } else {
        echo '<script>
        alert("El Registro de Entrega NO pudo ser actualizado");
...
$sqlEntregas = "SELECT * FROM entregas WHERE id = $id";
...
<body>
    ...
    <div class="container">
        <div class="form-header">
            ...
            <h4 style="color: black; text-align: center;">Editar Entrega de Equipo</h4>
            <br></br>
        </div>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="emp" name="emp" placeholder="Seleccione el colaborador" required onchange="cargarDepartamento()">
...
<script>
    function cargarDepartamento() {
        var empleadoSeleccionado = $("#emp").val();
        var departamentoSelect = $("#departamento");
        var depto = $("option:selected", "#emp").attr("data-depto");
