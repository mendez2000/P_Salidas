			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><a class="btn btn-success" href="/R_MEMORIAS/php/Editar_Estado.php?id=<?php echo $row->id; ?>">Editar</a>
						<td><a class="btn btn-danger" href="/R_MEMORIAS/php/Borrar_Estado.php?id=<?php echo $row->id; ?>" onclick="return confirm('Estás seguro que deseas eliminar el registro?');">Eliminar</a>
					</tr>
				<?php
				}
				?>
		</table>
		<td><a class="btn-editar" href="/R_MEMORIAS/php/Form_Estado.php">Regresar</a></td>
